<?php
	...
	class Question_Controller {
		...
		public static function show($id) {
			...
			"question" => $question,
			"user" => $user,
			"user_has_given_rating" => is_null($user) ? false : Rating_Model::user_has_given_rating($user->id, $question->id),
			"user_owns_question" => is_null($user) ? false : ($question->asked_by->id == $user->id)
			));
		}
